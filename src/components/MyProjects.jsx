      ...
      <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-col gap-3 sm:gap-4 p-4 sm:p-5 flex-1">
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                  {project.tech.map((t, i) => (
                    <span
                      key={i}
                      className="text-xs px-2.5 sm:px-3 py-1 rounded-full bg-[#38bdf8]/10 text-[#38bdf8] border border-[#38bdf8]/20 font-medium"
                    >
                      {t}
                    </span>
                  ))}
        ...
        <div className="flex justify-center mt-10 sm:mt-14">
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-6 sm:px-8 py-3 rounded-full border border-[#38bdf8]/40 text-[#38bdf8] text-sm font-semibold hover:bg-[#38bdf8]/10 hover:border-[#38bdf8] transition-all duration-300"
          >
            <FaGithub size={16} />
            View More on GitHub
          </Link>
